...
public static class ElementAction
{
    ...
    /// </summary>
    public static void ClickAndHold(this IWebDriver driver, By by)
    {
        var element = driver.WaitUtil(by);
    ...
    {
        var sourceElement = driver.WaitUtil(source);
        var targetElement = driver.WaitUtil(target);
        Actions actionProvider = new Actions(driver);
    ...
    /// </summary>
    public static void DragAndDropBy(this IWebDriver driver, By source, int targetEleOffsetX, int targetEleOffsetY)
    {
        var sourceElement = driver.WaitUtil(source);
        Actions actionProvider = new Actions(driver);
        // Performs drag and drop action of sourceEle onto the targetEle
    ...
    /// </summary>
    public static void ClickHoldAndRelease(this IWebDriver driver, By source, By target)
    {
        var sourceElement = driver.WaitUtil(source);
        var targetElement = driver.WaitUtil(target);
        Actions actionProvider = new Actions(driver);
